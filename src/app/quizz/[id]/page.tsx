...
export default function QuizzPage() {
  ...
  useEffect(() => {
    ...
    localStorage.setItem("currentQuestionIndex", `${id}`);
  ...
  if (loading)
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-white p-4">
        <div className="text-center max-w-xl text-2xl">Chargement…</div>
      </div>
    );
  if (!quizz || !quizz.question)
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-white p-4">
        <div className="text-center max-w-xl text-2xl">Quizz introuvable</div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-white p-4">
      <div className="text-center max-w-xl">
        <p className="mb-6 font-bold uppercase h-[60px]>">
          {id}/{allQuizz.length} - {quizz.question}
        </p>
